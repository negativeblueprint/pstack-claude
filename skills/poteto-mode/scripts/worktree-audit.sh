...
# Transcripts dir: ~/.claude/projects/<slugified-repo-path>/, holding <session-id>.jsonl.
# Claude Code keeps the leading separator as a dash, unlike Cursor which stripped it.
