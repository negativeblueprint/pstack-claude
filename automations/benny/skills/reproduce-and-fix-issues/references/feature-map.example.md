...
Copy this file outside `.github/benny/`, for example to `.claude/benny/feature-map.md`, and set `control.feature_map_path` to the copy. Pack refreshes must not overwrite it.
