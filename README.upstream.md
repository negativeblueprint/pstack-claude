...
to set it up, point cursor at [`FOR_AGENTS.md`](./automations/benny/FOR_AGENTS.md). setup copies the pack into the target repository at `.github/benny/`, enables pstack there for shared skills, and keeps user configuration outside the copied pack.
